...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 32, fontWeight: 'bold', textAlign: 'center', marginBottom: 10, color: '#111827' },
  subtitle: { fontSize: 16, textAlign: 'center', color: '#6b7280', marginBottom: 40 },
  buttonContainer: { gap: 15, marginBottom: 40 },
  primaryButton: { backgroundColor: '#10b981', paddingVertical: 16, borderRadius: 12, alignItems: 'center', marginTop: 20 },
  primaryButtonText: { color: '#fff', fontSize: 18, fontWeight: 'bold' },
  secondaryButton: { backgroundColor: '#3b82f6', paddingVertical: 16, borderRadius: 12, alignItems: 'center' },
  secondaryButtonText: { color: '#fff', fontSize: 18, fontWeight: 'bold' },
  backButton: { backgroundColor: '#e5e7eb', paddingVertical: 14, borderRadius: 12, alignItems: 'center', marginTop: 10 },
  backButtonText: { color: '#6b7280', fontSize: 16, fontWeight: '600' },
  infoCard: { backgroundColor: '#f3f4f6', padding: 20, borderRadius: 12 },
  infoTitle: { fontSize: 18, fontWeight: '600', marginBottom: 12, color: '#111827' },
  infoText: { fontSize: 14, color: '#6b7280', marginBottom: 8 },
  formContainer: { width: '100%' },
  label: { fontSize: 16, fontWeight: '600', marginBottom: 8, color: '#111827' },
  input: { borderWidth: 1, borderColor: '#d1d5db', borderRadius: 8, padding: 14, fontSize: 16, marginBottom: 20 },
  codeInput: { borderWidth: 2, borderColor: '#3b82f6', borderRadius: 12, padding: 20, fontSize: 32, fontWeight: 'bold', textAlign: 'center', letterSpacing: 4, marginBottom: 20 },
  distanceButtons: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginBottom: 20 },
  distanceButton: { flex: 1, minWidth: 60, backgroundColor: '#f3f4f6', paddingVertical: 12, borderRadius: 8, alignItems: 'center' },
  distanceButtonActive: { backgroundColor: '#10b981' },
  distanceButtonText: { fontSize: 16, fontWeight: '600', color: '#6b7280' },
  distanceButtonTextActive: { color: '#fff' },
  codeCard: { backgroundColor: '#f3f4f6', padding: 24, borderRadius: 16, alignItems: 'center', marginBottom: 20 },
  codeLabel: { fontSize: 14, color: '#6b7280', marginBottom: 8 },
  codeText: { fontSize: 48, fontWeight: 'bold', color: '#111827', letterSpacing: 4 },
  codeSubtext: { fontSize: 12, color: '#9ca3af', marginTop: 8 },
  distanceCard: { backgroundColor: '#3b82f6', padding: 20, borderRadius: 12, alignItems: 'center', marginBottom: 20 },
  distanceLabel: { fontSize: 14, color: '#dbeafe', marginBottom: 4 },
  distanceValue: { fontSize: 36, fontWeight: 'bold', color: '#fff' },
  participantsCard: { backgroundColor: '#f9fafb', padding: 20, borderRadius: 12, marginBottom: 20 },
  participantsTitle: { fontSize: 16, fontWeight: '600', marginBottom: 12, color: '#111827' },
  participantItem: { flexDirection: 'row', alignItems: 'center', paddingVertical: 8 },
  participantDot: { width: 12, height: 12, borderRadius: 6, backgroundColor: '#10b981', marginRight: 12 },
  participantName: { fontSize: 16, color: '#111827' },
  countdownText: { fontSize: 120, fontWeight: 'bold', textAlign: 'center', color: '#10b981' },
  myStatsCard: { backgroundColor: '#10b981', padding: 24, borderRadius: 16, marginBottom: 20 },
  myStatsLabel: { fontSize: 14, color: '#d1fae5', marginBottom: 8 },
  myStatsDistance: { fontSize: 32, fontWeight: 'bold', color: '#fff', marginBottom: 12 },
  progressBar: { height: 8, backgroundColor: 'rgba(255,255,255,0.3)', borderRadius: 4, marginBottom: 12 },
  progressFill: { height: '100%', backgroundColor: '#fff', borderRadius: 4 },
  myStatsPace: { fontSize: 16, color: '#d1fae5' },
  mapContainer: { width: '100%', height: 200, borderRadius: 12, overflow: 'hidden', marginBottom: 16 },
  map: { width: '100%', height: '100%' },
  leaderboardCard: { flex: 1, backgroundColor: '#f9fafb', borderRadius: 12, padding: 16, marginBottom: 16 },
  leaderboardTitle: { fontSize: 18, fontWeight: '600', marginBottom: 12, color: '#111827' },
  leaderboardScroll: { flex: 1 },
  leaderboardItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', padding: 12, borderRadius: 8, marginBottom: 8 },
  leaderboardRank: { fontSize: 20, fontWeight: 'bold', color: '#6b7280', width: 40 },
  leaderboardInfo: { flex: 1 },
  leaderboardName: { fontSize: 16, fontWeight: '600', color: '#111827' },
  leaderboardStats: { fontSize: 14, color: '#6b7280' },
  resultsCard: { backgroundColor: '#f9fafb', padding: 20, borderRadius: 12, marginBottom: 20 },
  resultsTitle: { fontSize: 20, fontWeight: '600', marginBottom: 16, textAlign: 'center', color: '#111827' },
  resultItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', padding: 16, borderRadius: 8, marginBottom: 12 },
  resultRankBadge: { width: 50, height: 50, borderRadius: 25, backgroundColor: '#f3f4f6', justifyContent: 'center', alignItems: 'center', marginRight: 16 },
  resultRankText: { fontSize: 24, fontWeight: 'bold' },
  resultInfo: { flex: 1 },
  resultName: { fontSize: 18, fontWeight: '600', color: '#111827', marginBottom: 4 },
  resultTime: { fontSize: 14, color: '#6b7280' },
  endRaceButton: { backgroundColor: '#ef4444', paddingVertical: 14, borderRadius: 12, alignItems: 'center' },
  endRaceButtonText: { color: '#fff', fontSize: 16, fontWeight: 'bold' },
})
